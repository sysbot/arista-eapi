...
module CLI
  ...
  class Username < Treetop::Runtime::SyntaxNode
    def to_array
  ...
  class Secret  < Treetop::Runtime::SyntaxNode
    def to_array
      return eval self.text_value
    end
  end

  class SSHKey < Treetop::Runtime::SyntaxNode
    def to_array
      return eval self.text_value
    end
  end
  ...
  class WordLiteral < Treetop::Runtime::SyntaxNode
    def to_array
      return self.text_value.to_sym
    end
  end
